...
def mnist_model(learning_rate, use_two_conv, use_two_fc, hparam, list_data, list_test_accuracy):
  ...
  with tf.name_scope("test_accuracy"):
    test_correct_prediction = tf.equal(tf.argmax(logits, 1), tf.argmax(y, 1))
  ...
  for i in range(n):
    ...
    # save data during the final step
    if i+1 == n:
...
def main():
  ...
  # data of training accuracy and time duration
  list_data = []

  # data of test accuracy
  list_test_accuracy = []
  ...
  for learning_rate in [1E-2]:
    ...
    for use_two_fc in [True]:
      ...
      for use_two_conv in [True]:
        ...
        mnist_model(learning_rate, use_two_fc, use_two_conv, hparam, list_data, list_test_accuracy)
  print('results: ')
  print(list_data)
